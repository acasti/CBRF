...
% 
% Written by Alex Casti, Cooper Union Department of Mathematics, 15 December 2008
%-----------------------------------------------------------------------------------------------
...
% Define the mean of all mean square departures, excluding the obvious zero value
%  associated with the mean square departure of the reference with itself.
mse_mean = sum(mse(:))/(numel(ISIdata.Nhist_normalized)-1);

% Define another mean mse measure by excluding extremely low and high rates.  Call it 
%  mse_mean_exclude_lowhigh.
M = mse(2:end,:);
