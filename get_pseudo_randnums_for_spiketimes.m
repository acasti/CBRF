...
%                                                   position; default value of this argument is 4)
% OUTPUT:  R                               * (int vector) non-repeating integer vector of length 10^N - 1
%          varargout{1}                    * (output argument cell array)
%                      Rscaled             * (vector) scaled version of R suitable for adding to spike times (sec)
